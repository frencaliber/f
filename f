...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(6,6,6)
    else
    MainColor = Color3.fromRGB(27, 42, 53)
    Background = Color3.fromRGB(27, 33, 54)
    zyColor= Color3.fromRGB(37, 44, 72)
    beijingColor = Color3.fromRGB(22, 27, 45)
end
